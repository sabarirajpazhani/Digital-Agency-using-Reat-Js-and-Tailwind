  ...
  return (
    <div className='max-w-screen overflow-x-hidden font-poppins'>
      <div className='w-full py-[10rem] px-4 bg-white -mt-28'>
        ...
        <p className="flex text-xl justify-center sm:mb-24 mb-16 text-center mt-6 sm:mt-0 ">Find your Package that fits your needs, weather your a new company or a Enterprise wee got you covered!</p>
        {/* Cards */}
        <>
        {Width <631 ? (
          <>
          ...
          Feature3={"nnovative Technology Integration"}
