        ...
        <nav className='bg-gray-900 fixed px-2 sm:h-auto sm:w-full w-screen z-20 left-0 right-0 top-0 border-b border-gray-400'>
            ...
            <div className='max-w-screen-xl flex flex-wrap items-center justify-between mx-auto sm:p-4 pb-2'>
              <Link to='/' className='flex items-center'> 
                ...
                <span className='ml-2 mt-2 sm:mt-0 text-white font-semibold text-xl'>CyberCrafters Solutions</span>
              </Link>
              ...
              <div className='flex'>
                <button type='button' className=' bg-blue-600 px-4 py-2 text-white hidden sm:block rounded-xl mr-4 hover:bg-blue-500'>
                  Get Started
                </button>
                <button type='button' className='hidden sm:block text-white border font-medium rounded-lg ml-2 text-sm px-4 hover:bg-blue-300/10 mr-4'>
                  Login
                </button>
            ...
            <div className={`${open ? null: "hidden"} h-[19rem]`}>
              ...
              <div className='flex cursor-pointer'>
                <img src={profileImage} alt="profileimg" className='w-14 ml-8 mt-4 flex' />
                <p className='my-auto ml-4 text-white font-semibold'>SabariRaj</p>
                <p className='my-auto ml-2 text-white font-semibold'>Pazhani</p>
              </div>
              <p className='my-auto ml-[103px] mt-[-27px]  text-xs font-light text-gray-200/60'>Sabariraj@gmail.com</p>
              </div>
              ...
              <div  className='flex justify-center'>
                <p className='mt-[25px] text-gray-100/30 text-sm'>All Rights Reserved - CyberCrafters Solutions</p>
              </div>
            </div>
        </nav>
    </div>
