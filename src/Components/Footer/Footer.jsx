            ...
            <div className='text-white sm:w-[900px] sm:ml-[18%] sm:mr-[12%] sm:pt-0'>
                ...
                <div className='my-4'>
                    <div className='justify-center flex'>
                        <input className='placeholder:pl-2 flex mr-[-50] h-10 sm:w-[50%] sm:h-[50%] mx-auto rounded-md text-black' type="emial" placeholder='Enter your Email'/>
                        <button className='bg-blue-400 mx-auto w-28 hover:bg-blue-500 rounded-md font-mediums'>Sign Up</button>
                    </div>
