...
function Review() {
    ...
    <div className='overflow-x-hidden max-w-screen font-poppins'>
		...
		<div className="grid items-center gap-4 xl:grid-cols-5">
            ...
            <p className="text-black">Here are some reviews of our costumers and their excperience with our services and that wee provide!</p>
			</div>
			<div className="p-6 xl:col-span-3">
				<div className="grid gap-4 md:grid-cols-2">
					<div className="grid content-center gap-4">
						<div className="p-6 rounded shadow-md bg-blue-200/30">
							<p>I recently used the services of this agency, and I am
                          ...
                          <div className="flex justify-between items-center mt-4 space-x-4">
                                <div className='flex'>
                                <img src="https://unsplash.com/photos/cheerful-young-asian-man-holding-credit-card-and-smiling-to-camera-1G0pGhIFQkw" alt="Profile Photo" className="w-12 h-12 bg-center bg-cover rounded-full" />
						...
						<div className="p-6 rounded shadow-md bg-blue-200/60">
							<p>I cannot say enough good things about this agency. The
                          ...
                          the future.</p>
							<div className="flex justify-between items-center mt-4 space-x-4">
								...
								<div className='flex-col ml-4'> 
									<p className="text-lg font-semibold">Sophia Davis</p>
					...
					<div className="grid content-center gap-4">
						<div className="p-6 rounded shadow-md bg-blue-200/60">
							<p>I have had the pleasure of working with this agency,
                          ...
                          them to others.</p>
							<div className="flex justify-between items-center mt-4 space-x-4">
								...
								<div className='text-md font-semibold'> 
									<p className="text-lg font-semibold"> Olivia Johnson</p>
									<p className="text-sm text-gray-400">Redmi</p>
								</div>
                                </div>
                                <div className='flex'>
                                    <MdVerified size={Width< 631 ? 35:40} className='text-green-400 ml-2'/>
						...
						<div className="p-6 rounded shadow-md bg-blue-200/30">
							<p>I recently engaged this agency for their services, and
                          ...
                          recommend their services to anyone seeking excellence.</p>
                          <div className="flex justify-between items-center mt-4 space-x-4">
                                <div className='flex'>
                                <img src="https://source.unsplash.com/50x50/?portrait?1" alt="" className="w-12 h-12 bg-center bg-cover rounded-full" />
								<div className='text-md flex-col ml-4'> 
									<p className="text-lg font-semibold">Jackson</p>
									<p className="text-sm text-gray-400">Dell</p>
								</div>
                                </div>
                                <div className='flex'>
                                    <MdVerified size={Width< 631 ? 35:40} className='text-green-400 ml-2'/>
