...
function Features() {
  ...
  return (
	...
	<div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
		<div>
			<h2 className="text-3xl font-bold tracking-tight text-center sm:text-5xl dark:text-gray-900">Empowering Business</h2>
			<p className="max-w-3xl mx-auto mt-4 text-xl text-center">Growth Through Advanced Technology Solutions, Analytics and
            Professionaly Trained Personnel</p>
		</div>
				...
				<div className="mt-12 space-y-12">
					...
					<div className="flex">
						...
						<div className="ml-4">
							...
							<p className="mt-2 ">Our trained experts ensure smooth implementation and
                            ongoing guidance. Leverage our software effectively
                            with personalized assistance.</p>
						</div>
					</div>
